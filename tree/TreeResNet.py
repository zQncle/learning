...
def load_data_leaves(train_transform=None, test_transform=None):
    ...
    sample_data = pd.read_csv('D:/PycharmProjects/learning/tree/treeData/sample_submission.csv.csv')
    ...
    sample_data['label'] = labelencoder.transform(sample_data['label'])
    ...
    sample_dataSet = LeavesSet(sample_data['image'], sample_data['label'], transform=train_transform, train=True)
...
train_dataset, sample_dataset, test_dataset, label_map, label_inv_map = load_data_leaves(train_transform, test_transform)
